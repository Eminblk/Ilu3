...
//		// TP4 Partie 1
		boolean depotOK1 = false;
		// Feu rouge
		System.out.println("Deposer carte Feu rouge");
		depotOK1 = zoneDeJeu.estDepotAutorise(Cartes.FEU_ROUGE);
		...
		depotOK1 = zoneDeJeu.estDepotAutorise(Cartes.PRIORITAIRE);
		System.out.println("d�p�t ok ? " + depotOK1);
		if (depotOK1) {
		...
		// accident
		System.out.println("Deposer carte attaque - accident");
		depotOK1 = zoneDeJeu.estDepotAutorise(new Attaque(Type.ACCIDENT));
		System.out.println("d�p�t ok ? " + depotOK1);
		if (depotOK1) {
		...
		depotOK1 = zoneDeJeu.estDepotAutorise(new Botte(Type.CREVAISON));
		if (depotOK1) {
		...
		// Feu vert
		System.out.println("Deposer carte Feu vert");
		depotOK1 = zoneDeJeu.estDepotAutorise(Cartes.FEU_VERT);
		System.out.println("d�p�t ok ? " + depotOK1);
		if (depotOK1) {
		...
		// D�pot limitation de vitesse 50 bornes
		System.out.println("Deposer carte limite - 50");
		depotOK1 = zoneDeJeu.estDepotAutorise(new DebutLimite());
		System.out.println("d�p�t ok ? " + depotOK1);
		if (depotOK1) {
			zoneDeJeu.deposer(new DebutLimite());
		}
